...
while(1):
	...
	if(PreviousMinute==0):
		try:
			...
			print("unable to record data for TESLA")

		try:
			RoomLumiere.EnergyReport();
		except:
			print("unable to record data for LUMIERE")

		try:
			RoomNobel.EnergyReport();
		except:
			print("unable to record data for NOBEL")
		
		try:
			RoomTuring.EnergyReport();
		except:
			print("unable to record data for TURING")
			
		try:
			AllBuilding.EnergyReport();
		except:
			print("unable to record data for ALL BUILDING")
